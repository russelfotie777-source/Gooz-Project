...
// Mobile order history — reached from the "Historique des commandes" row in
// ProfilePage. No Figma node (backend-driven feature); layout mirrors
// AddressesPage/ProfilePage's topBar + card conventions.
              ...
              return (
                <div key={order.id} className={styles.card}>
                  ...
                  <div className={styles.cardFooter}>
                    <span className={styles.totalLabel}>{dict.orders.total}</span>
