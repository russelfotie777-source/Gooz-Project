...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // 2026_09_02_135138_add_ad_slot_locations_to_banners_table.php.
        if (DB::connection()->getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE banners MODIFY location ENUM('homepage', 'homepage_ad_1', 'homepage_ad_2', 'category', 'search', 'checkout', 'product') NOT NULL DEFAULT 'homepage'");
        }
    }
    ...
    {
        DB::statement("UPDATE banners SET location = 'homepage' WHERE location = 'product'");
