...
class UpdateHomepageSectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'display_title' => ['sometimes', 'required', 'string', 'max:255'],
            'description' => ['nullable', 'string'],

            'section_type' => ['sometimes', 'required', Rule::in(['automatic', 'manual', 'mixed'])],
            'display_layout' => ['sometimes', 'required', Rule::in(['horizontal_list', 'grid'])],
            'automatic_strategy' => [
            ...
            'display_mode' => ['sometimes', 'required', Rule::in(['variants', 'products'])],
            'sort_direction' => ['sometimes', 'required', Rule::in(['asc', 'desc'])],

            'item_limit' => ['sometimes', 'required', 'integer', 'min:1', 'max:100'],
            'visibility' => ['sometimes', 'required', Rule::in(['everyone', 'logged_in', 'guests'])],
