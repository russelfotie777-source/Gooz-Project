...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Widget téléchargement app", href: "/dashboard/promo-app", icon: Smartphone, ready: true },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Rapport des paiements", href: "/dashboard/rapports/paiements", icon: CreditCard, ready: true },
      { label: "Rapport des paiements en attente", href: "/dashboard/rapports/paiements-attente", icon: CreditCard, ready: true },
    ],
  },
];
